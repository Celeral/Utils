...
/**
 * A Thread Factory where one can decide how they want to name the
 * threads generated by this factory. In addition to the name of the
 * threads, the daemon property of the thread is also inherited from
 * the group that's registered with this ThreadFactory.
 *
 * Both the pattern for the name and the group can be changed anytime.
 *
 * @since 1.1.0
 */
public class NamedThreadFactory implements ThreadFactory
{
   ...
   * @param pattern name of threads is derived by substituting
  ...
  /**
   * Creates a new ThreadFactory using the group and default
   * pattern.The default pattern is "{groupName}-{poolSequence}-{threadSequence}"
   *
