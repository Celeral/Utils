 ...
 * Such a map is useful to be used as a cache which gets auto cleaned as and when the keys have no more
 * strong references to them anywhere in the system and hence garbage collected by the JVM.
  ...
  private final class IdentityWeakReference extends WeakReference<K>
  {
    ...
    public boolean equals(Object obj)
    {
      ...
      if (obj instanceof WeakIdentityHashMap.IdentityWeakReference) {
        @SuppressWarnings("unchecked") final IdentityWeakReference ref = (IdentityWeakReference)obj;
